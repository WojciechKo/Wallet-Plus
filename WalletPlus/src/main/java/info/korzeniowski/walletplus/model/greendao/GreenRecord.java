...
public class GreenRecord {
    ...
    public GreenRecord(Record record) {
        setId(record.getId());
    ...
    public static Record toRecord(GreenRecord greenRecord) {
        Record result = new Record();
        result.setId(greenRecord.getId());
        result.setAmount(greenRecord.getAmount());
        result.setCategoryId(greenRecord.getCategoryId());
        result.setDescription(greenRecord.getDescription());
        result.setDateTime(greenRecord.getDateTime());
        return result;
    }
    // KEEP METHODS END
}

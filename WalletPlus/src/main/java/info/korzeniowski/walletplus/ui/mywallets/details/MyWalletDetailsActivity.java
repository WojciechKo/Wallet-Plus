...
public class MyWalletDetailsActivity extends BaseActivity {
    public static final String TAG = MyWalletDetailsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.container, MyWalletDetailsFragment.newInstance(walletId))
                    .commit();
        }
        ...
        getActionBarToolbar().setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavUtils.navigateUpFromSameTask(MyWalletDetailsActivity.this);
            }
        });
    }
